...
contract LZCommon is Test {
    ...
    function setUp() virtual public {
        ...
        ReceiveUln302 = new ReceiveUln302(address(endpoint));
        SendUln302 = new SendUln302(address(endpoint));
        ...
        // Set default libs
        endpoint.setDefaultSendLibrary(remoteEid, address(SendUln302));
        endpoint.setDefaultReceiveLibrary(remoteEid, address(ReceiveUln302), 0);
