 ...
 * the incentive contract when ackMessage is called.
 */
contract ReturnBomber is ICrossChainReceiver {
    ...
    function ackMessage(bytes32 /* destinationIdentifier */, bytes32 /* messageIdentifier */, bytes calldata /* acknowledgement */) view external {
